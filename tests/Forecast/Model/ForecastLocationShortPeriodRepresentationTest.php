...
#[CoversClass(ForecastLocationShortPeriodRepresentation::class)]
final class ForecastLocationShortPeriodRepresentationTest extends TestCase
{
    public function test(): void
    {
        $representation = new ForecastLocationShortPeriodRepresentation(1, 2, 3, 4, 5, 6, Visibility::GOOD, WeatherType::CLEAR_NIGHT, WindDirection::NORTH, 7, 8);
        self::assertSame(1, $representation->getFeelsLike());
        self::assertSame(2, $representation->getMaxUvIndex());
        self::assertSame(3, $representation->getTimePeriod());
