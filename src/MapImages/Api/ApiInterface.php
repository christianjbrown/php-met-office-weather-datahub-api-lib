...
{
    public const string API_URL_ORDER_FILE_DATA_SPRINTF = 'https://data.hub.api.metoffice.gov.uk/map-images/1.0.0/orders/%s/latest/%s/data';
    public const string API_URL_ORDER_FILE_SPRINTF = 'https://data.hub.api.metoffice.gov.uk/map-images/1.0.0/orders/%s/latest/%s';
    public const string API_URL_ORDER_LATEST_SPRINTF = 'https://data.hub.api.metoffice.gov.uk/map-images/1.0.0/orders/%s/latest';
    public const string API_URL_ORDERS = 'https://data.hub.api.metoffice.gov.uk/map-images/1.0.0/orders';
    public const string API_URL_RUNS = 'https://data.hub.api.metoffice.gov.uk/map-images/1.0.0/runs';
